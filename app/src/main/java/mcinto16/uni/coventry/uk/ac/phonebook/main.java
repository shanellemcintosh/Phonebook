package mcinto16.uni.coventry.uk.ac.phonebook;
...
public class main extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabSpec.setContent(R.id.tabNewContact);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view) {
                ...
                populateList(); //Adds contact to contact list, when button has been clicked.
        ...
        nameTxt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                //Add button not enabled if nothing entered in name field
            }
